...
BOT_TOKEN = environ.get('BOT_TOKEN', '5048328047:AAHeKjnDkJkbBFWsuMY9-WoCYplBmDjyHgI')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1654009706 5139420709').split()]
